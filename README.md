...
4. Used Claude Design, combining elements of the HomeVision design system (from their website and images of their tooling on LinkedIn) along with specific instructions to Claude on how the UI should function.
